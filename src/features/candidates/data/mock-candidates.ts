...
const firstNames = [
  ...
  'Arnav', 'Dhruv', 'Kabir', 'Ritvik', 'Aarush', 'Ayaan', 'Shaurya', 'Atharv',
  'Advait', 'Krishna', 'Ishaan', 'Rudra', 'Priya', 'Ananya', 'Aanya', 'Aadhya',
  'Diya', 'Myra', 'Sara', 'Ira', 'Anika', 'Kiara', 'Riya', 'Avni', 'Anvi',
  'Navya', 'Shanaya', 'Aarohi', 'Saanvi', 'Pari', 'Aditi', 'Kavya', 'Neha',
  'Pooja', 'Sneha', 'Megha', 'Tanvi', 'Shruti', 'Divya', 'Rashmi', 'Swati', 'Mansi',
]

const lastNames = [
  'Sharma', 'Verma', 'Patel', 'Gupta', 'Singh', 'Kumar', 'Reddy', 'Rao',
  'Iyer', 'Nair', 'Menon', 'Pillai', 'Das', 'Bose', 'Sen', 'Chatterjee',
  'Mukherjee', 'Banerjee', 'Joshi', 'Kulkarni', 'Deshmukh', 'Patil', 'Shah',
  'Mehta', 'Jain', 'Agarwal', 'Khanna', 'Kapoor', 'Malhotra', 'Chopra',
]

const cities = [
  'Mumbai', 'Bangalore', 'Delhi', 'Hyderabad', 'Chennai', 'Pune', 'Kolkata',
  'Ahmedabad', 'Gurgaon', 'Noida', 'Jaipur', 'Lucknow', 'Kochi', 'Chandigarh',
  'Indore', 'Coimbatore', 'Thiruvananthapuram', 'Bhubaneswar', 'Nagpur', 'Vadodara',
]
...
const jobTitles = [
  ...
  'QA Engineer', 'SDET', 'Security Engineer', 'Mobile Developer',
  'iOS Developer', 'Android Developer', 'React Native Developer',
  'Solution Architect', 'Technical Lead', 'Principal Engineer',
]

const skillsPool = [
  'React', 'TypeScript', 'JavaScript', 'Node.js', 'Python', 'Java', 'Go',
  'Rust', 'C++', 'C#', 'AWS', 'Azure', 'GCP', 'Docker', 'Kubernetes',
  ...
  'Agile', 'Scrum', 'CI/CD', 'Git', 'Linux', 'Terraform', 'Jenkins',
  'Angular', 'Vue.js', 'Next.js', 'Django', 'Flask', 'Spring Boot',
  'Kafka', 'RabbitMQ', 'Elasticsearch', 'Spark', 'Hadoop', 'Airflow',
]

const educationLevels = [
  'B.Tech', 'B.E.', 'M.Tech', 'M.E.', 'MCA', 'BCA', 'B.Sc', 'M.Sc', 'MBA', 'PhD',
]

const institutions = [
  'IIT Bombay', 'IIT Delhi', 'IIT Madras', 'IIT Kanpur', 'IIT Kharagpur',
  'IIT Roorkee', 'IIT Guwahati', 'IIT Hyderabad', 'BITS Pilani', 'NIT Trichy',
  'NIT Warangal', 'NIT Surathkal', 'IIIT Hyderabad', 'VIT Vellore', 'SRM Chennai',
  'Manipal Institute of Technology', 'COEP Pune', 'Anna University', 'Delhi University',
  'Mumbai University', 'Jadavpur University', 'PSG Tech', 'RV College', 'PES University',
]
...
const documentsOptions = [
  'Aadhaar', 'PAN', 'Education Certificate', 'Experience Letter',
